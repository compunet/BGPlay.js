...
BgplayGraph.prototype.computePosition = function () {
    var cycles = [];
    var orbits = [];
    var orbit, node , h, length, n, radius, pi2, lengthOrbit, spaceOrbit, parents;
    ...
    var whenHookInteractionsStarts = springEmbedderCyclesPercentage * this.environment.config.graph.whenHookInteractionsStarts;
    var whenHookInteractionsEnds = springEmbedderCyclesPercentage * this.environment.config.graph.whenHookInteractionsEnds;
    var whenOnlyLeavesRepulsion = springEmbedderCyclesPercentage * this.environment.config.graph.whenOnlyLeavesRepulsion;
    var whenCoulombStarts = springEmbedderCyclesPercentage * this.environment.config.graph.whenCoulombRepulsionStarts;
    var whenCoulombEnds = springEmbedderCyclesPercentage * this.environment.config.graph.whenCoulombRepulsionEnds;
