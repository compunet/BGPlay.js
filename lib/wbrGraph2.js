...
BgplayGraph.prototype.getScaleFactor = function(width, height){
    var maxX, minX, maxY, minY, hOuter, wOuter, scaleFactor, refresh;
    refresh = true;
    maxX = this.getMaxX(refresh);
    minX = this.getMinX(refresh);
    maxY = this.getMaxY(refresh);
    minY = this.getMinY(refresh);
    wOuter = (maxX-minX);
    hOuter = (maxY-minY);
