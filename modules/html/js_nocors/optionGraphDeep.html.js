...
'    <label for="optionGraphDeep">Cut graph at deep:</label>'+
'    <input type="text" class="optionGraphDeepValue" value="1" style="border: 0; color: #f6931f; background:transparent; width:15px;" />'+
