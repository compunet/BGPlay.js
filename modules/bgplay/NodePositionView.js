...
var NodePositionView=Backbone.View.extend({
    ...
    initialize:function(){
        ...
        this.environment.optionalParams.push('nodePositions');
        this.positions="";
