...
var TimelineView=Backbone.View.extend({
    ...
    updateSelectionCanvas:function(){
        var selectedEventColor = this.environment.config.eventSelectedColor;
    ...
    getEventColor:function(eventType){
        ...
        switch (mainType) {
            ...
            default: //bgp
                switch (eventType) {
                    case "withdrawal":
                        color=this.environment.config.eventWithdrawalColor;
                        break;
                    case "announce":
                        color=this.environment.config.eventAnnounceColor;
                        break;
                    case "reannounce":
                        color=this.environment.config.eventReannunceColor;
                        break;
                    case "pathchange":
                        color=this.environment.config.eventPathchangeColor;
                        break;
                    case "prepending":
                        color=this.environment.config.eventPrependingColor;
                        break;
                    case "initialstate":
                        color=this.environment.config.eventInitialstateColor;
                        break;
                    default:
                        color="black";
                }
