...
define(function(){
    return{
        homeUrl:"http://nero.dia.uniroma3.it/xxxxx",
        safetyMaximumNodes:150,
        safetyMaximumEvents:20000,
        //possibleRrcs:[00,01,02,03,04,05,06,07,08,09,10,11,12,13,14,15,16], // An array of RRC
        //rrcs:[00,01,02,03,04,05,06,07,08,09,10,11,12,13,14,15,16], // An array of RRC used by default
        possibleRrcs:[00,01,03,04,05,06,07,10,11,12,13,14,15],
        selectedRrcs:[00,03,13,15],
        selectableRrcs:true,
        ignoreReannouncementsByDefault:true,
        cumulativeAnimations:true,
        bgpEventWithdrawalColor:"#BA0019",
        bgpEventAnnounceColor:"#2EA300",
        bgpEventInitialstateColor:"gray",
        bgpEventReannunceColor:"#1A5C00",
        bgpEventPathchangeColor:"orange",
        bgpEventPrependingColor:"#F5E53B",
        bgpEventSelectedColor:"#63CBFF",
