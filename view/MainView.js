...
var MainView=Backbone.View.extend({
    ...
    layoutManager:function(){
        ...
        this.centerDiv.height(Math.max((this.environment.thisWidget.get_pref_height()|| (this.environment.widget_width/100)*120) - this.infoDiv.outerHeight(true) - this.timelineDiv.outerHeight(true) - marginTop, this.environment.config.graph.paperMinHeight));
