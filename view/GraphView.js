...
var GraphView=Backbone.View.extend({
    ...
    initialize:function(){
        ...
        //this.scaleFactor = this.graph.getScaleFactor(this.environment.widget_width);

        this.computeSubTrees();

        if (this.environment.config.graph.computeNodesPosition==true && this.environment.params.nodePositions==null){
